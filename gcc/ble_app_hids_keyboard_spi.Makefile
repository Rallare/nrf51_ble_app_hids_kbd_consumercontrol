...
OUTPUT_FILENAME := ble_app_hids_keyboard_spi

CFLAGS := -DDEBUG_NRF_USER -DBLE_STACK_SUPPORT_REQD -DSPI_MASTER_0_ENABLE -DSVCALL_AS_NORMAL_FUNCTION  
...
C_SOURCE_FILES += ser_phy_nrf51_spi_master.c
